...
--
-- Host: 127.0.0.1
-- Generation Time: 2014-10-06 11:16:12
-- 服务器版本： 5.6.21
-- PHP Version: 5.3.29
...
CREATE TABLE IF NOT EXISTS `x_express` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(2, 'express', 'shunfeng', '顺丰', 99, 1, 0),
(3, 'express', 'yuantong', '圆通', 99, 1, 0),
(4, 'freight', 'payed', '已付', 99, 1, 0),
(5, 'purchase', '', '供应商采购', 99, 1, 0),
(6, 'sale', '', '3', 99, 1, 1),
(7, 'sale', '33', '123', 99, 1, 0),
(8, 'produce', 'asdf', 'asdf', 99, 1, 1);
...
(1, 'admine@ng-erp.com', '管理员1', 'admin', '4297f44b13955235245b2497399d7a93', '123123', 1, 2, NULL);
...
(2, 1, '确认入库', 1, 'ConfirmStockin', 1, '1', '0', 'd:10|g:1', '0', -1, 0, 0, 0, '已入库', '0', '', ''),
...
(6, 2, '生成发货单', 1, 'MakeExpress', 2, '4', '7', 'g:', '0', -1, 0, 1, 0, '待发货', '0', '', ''),
