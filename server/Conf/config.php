...
$BASEConfig = array(
     ...
     * API KEY
     * **/
    'SERVICE_API_KEY' => '85239142af2934032d73587ee24a21b9',
    'SERVICE_SECRET_KEY' => 'fa2ffafcbf0345f0adcf85d2e0da5e9f17e472b3',

    /* 数据库配置 */
    'DB_TYPE'            =>    'mysqli',        // 数据库类型
    'DB_HOST'            =>    '127.0.0.1',    // 数据库服务器地址
    'DB_NAME'            =>    'ones_install',            // 数据库名
    'DB_USER'            =>    'root',        // 数据库用户名
    'DB_PWD'             =>    '',    // 数据库密码
    'DB_PORT'            =>    '3306',            // 数据库端口
    'DB_PREFIX'          =>    'ones_',            // 数据库表前缀
    ...
    'AUTH_CONFIG'=>array(
        ...
        'AUTH_GROUP' => 'ones_auth_group', //用户组数据表名
        'AUTH_GROUP_ACCESS' => 'ones_auth_group_access', //用户组明细表
        'AUTH_RULE' => 'ones_auth_rule', //权限规则表
        'AUTH_USER' => 'ones_user',//用户信息表
        /**
         * 无需登录模块
         */
